...
$outputFileName = '../../json/birthdays.json';

// Сохраняем JSON файл 
if (file_put_contents($outputFileName, $jsonData)) {
    echo 'Данные успешно сохранены в файл birthdays.json' .  PHP_EOL;
} else {
    echo 'Не удалось сохранить данные в файл birthdays.json' .  PHP_EOL;
}
